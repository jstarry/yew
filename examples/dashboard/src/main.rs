...
impl Model {
    ...
    fn fetch_json(ctx: &Context<Self>, binary: AsBinary) -> yew::services::fetch::FetchTask {
    ...
    pub fn fetch_toml(ctx: &Context<Self>, binary: AsBinary) -> yew::services::fetch::FetchTask {
        let callback = ctx.batch_callback(
