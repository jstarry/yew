    ...
    COMP::Properties: Default,
{
    ...
    /// Alias to `mount("body", ...)`.
    pub fn mount_to_body(self) -> Context<COMP> {
    ...
    pub fn mount_as_body(self) -> Context<COMP> {
    ...
    COMP: Component,
{
    ...
    pub fn mount_to_body_with_props(self, props: COMP::Properties) -> Context<COMP> {
        // Bootstrap the component for `Window` environment only (not for `Worker`)
        let element = document()
            .query_selector("body")
            .expect("can't get body node for rendering")
    ...
    /// CSS classes of the body element.
    pub fn mount_as_body_with_props(self, props: COMP::Properties) -> Context<COMP> {
        let html_element = document()
            .query_selector("html")
            .expect("can't get html node for rendering")
            .expect("can't unwrap html node");
