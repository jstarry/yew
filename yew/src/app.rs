    ...
    COMP::Properties: Default,
{
    ...
    pub fn mount(self, element: Element) -> Link<COMP> {
        let context = Link::new(None);
    ...
    /// Alias to `mount("body", ...)`.
    pub fn mount_to_body(self) -> Link<COMP> {
    ...
    pub fn mount_as_body(self) -> Link<COMP> {
    ...
    COMP: Component,
{
    ...
    pub fn mount_with_props(self, element: Element, props: COMP::Properties) -> Link<COMP> {
        clear_element(&element);
        let context = Link::new(None);
    ...
    pub fn mount_to_body_with_props(self, props: COMP::Properties) -> Link<COMP> {
        // Bootstrap the component for `Window` environment only (not for `Worker`)
        let element = document()
            .query_selector("body")
            .expect("can't get body node for rendering")
    ...
    /// CSS classes of the body element.
    pub fn mount_as_body_with_props(self, props: COMP::Properties) -> Link<COMP> {
        let html_element = document()
            .query_selector("html")
            .expect("can't get html node for rendering")
            .expect("can't unwrap html node");
